...
"use client";
/* eslint-disable @typescript-eslint/no-explicit-any, @typescript-eslint/no-unused-vars, prefer-const -- Legacy browser fixture retained only for reference; the routed default export is inert. */
